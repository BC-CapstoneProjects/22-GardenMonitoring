...
// Define the color values for each category
const colors = {
...
// Define an array of dates and values to generate the JSON objects
const dates = ["04/12/2023", "04/13/2023", "04/14/2023","04/15/2023","04/16/2023","04/17/2023"];
const valuesList = [  [12, 4, 25, 42, 12, 0],
  [13, 5, 7, 34, 2, 1],
  [12, 6, 23, 7, 25, 0],
  [5, 6, 23, 3, 2, 0],
  [12, 26, 13, 9, 2, 1],
...
const mockBarDataList = [];

// Iterate over the dates and values to generate the JSON objects
for (let i = 0; i < dates.length; i++) {
  const mockBarData = { date: dates[i] };

  labels.forEach((label, index) => {
    mockBarData[label] = valuesList[i][index];
    mockBarData[`${label}Color`] = colors[label];
  });

  mockBarDataList.push(mockBarData);
}
// Format the array of JSON objects as a JSON string
export const mockBarDataListJSON = mockBarDataList;
